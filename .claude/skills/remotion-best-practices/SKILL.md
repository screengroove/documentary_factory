...
This skill is used in a **graduation montage** video project. The stack is **Remotion** (primary) + **HeyGen** (AI-generated avatar/student video segments). Student photo assets are in `public/students/<Name>/`; group shots in `public/group_shots/`.
